...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'GadgetsDetail.username'
        db.alter_column('core_gadgetsdetail', 'username', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'GadgetsDetail.password'
        db.alter_column('core_gadgetsdetail', 'password', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'GadgetsDetail.username'
        db.alter_column('core_gadgetsdetail', 'username', self.gf('django.db.models.fields.CharField')(default='', max_length=50))

        # Changing field 'GadgetsDetail.password'
        db.alter_column('core_gadgetsdetail', 'password', self.gf('django.db.models.fields.CharField')(default='', max_length=100))
