...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('core_activetoken', (
        ...
        db.send_create_signal('core', ['ActiveToken'])


    def backwards(self, orm):
        
        # Deleting model 'ActiveToken'
        db.delete_table('core_activetoken')
    ...
    models = {
        ...
        'core.report': {
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 30, 6, 53, 17, 132920)'}),
