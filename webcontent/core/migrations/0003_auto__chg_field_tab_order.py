...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Tab.order'
        db.alter_column('core_tab', 'order', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Tab.order'
        db.alter_column('core_tab', 'order', self.gf('django.db.models.fields.IntegerField')(default=None))
