...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Member.e_new_report'
        db.delete_column('core_member', 'e_new_report')

        # Adding field 'Member.e_favourite'
        db.add_column('core_member', 'e_favourite', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Member.e_new_report'
        db.add_column('core_member', 'e_new_report', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'Member.e_favourite'
        db.delete_column('core_member', 'e_favourite')
    ...
    models = {
        ...
        'core.member': {
            ...
            'e_favourite': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            ...
            'handle': ('django.db.models.fields.CharField', [], {'max_length': '200', 'unique': 'True', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'core.report': {
            ...
            'hash_code': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_hide': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'next_update_time': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 6, 10, 9, 39, 964021)'}),
