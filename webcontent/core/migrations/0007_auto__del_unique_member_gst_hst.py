...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Member', fields ['gst_hst']
        db.delete_unique('core_member', ['gst_hst'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Member', fields ['gst_hst']
        db.create_unique('core_member', ['gst_hst'])
    ...
    models = {
        ...
        'core.member': {
            ...
            'gst_hst': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            ...
            'paypal': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
        ...
        'core.report': {
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 9, 7, 51, 12, 338315)'}),
