...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'TabGadgetsR.rss_url'
        db.alter_column('core_tabgadgetsr', 'rss_url', self.gf('django.db.models.fields.URLField')(max_length=1000, null=True))


    def backwards(self, orm):
        
        # Changing field 'TabGadgetsR.rss_url'
        db.alter_column('core_tabgadgetsr', 'rss_url', self.gf('django.db.models.fields.URLField')(max_length=100, null=True))
    ...
    models = {
        ...
        'core.tabgadgetsr': {
            ...
            'rss_url': ('django.db.models.fields.URLField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
