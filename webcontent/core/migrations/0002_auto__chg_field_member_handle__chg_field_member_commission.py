...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Member.handle'
        db.alter_column('core_member', 'handle', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True, null=True))

        # Changing field 'Member.commission'
        db.alter_column('core_member', 'commission', self.gf('django.db.models.fields.IntegerField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'Member.handle'
        db.alter_column('core_member', 'handle', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, unique=True))

        # Changing field 'Member.commission'
        db.alter_column('core_member', 'commission', self.gf('django.db.models.fields.IntegerField')(default=None))
    ...
    models = {
        ...
        'core.report': {
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 3, 30, 6, 14, 33, 840699)'}),
