...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Report.next_update_time'
        db.add_column('core_report', 'next_update_time', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'Report.hash_code'
        db.add_column('core_report', 'hash_code', self.gf('django.db.models.fields.CharField')(default=None, max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Report.next_update_time'
        db.delete_column('core_report', 'next_update_time')

        # Deleting field 'Report.hash_code'
        db.delete_column('core_report', 'hash_code')
    ...
    models = {
        ...
        'core.report': {
            ...
            'publish_time': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 4, 6, 9, 44, 52, 204106)'}),
