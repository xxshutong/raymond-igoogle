...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TabGadgetsR.rss_url'
        db.add_column('core_tabgadgetsr', 'rss_url', self.gf('django.db.models.fields.URLField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'TabGadgetsR.rss_url'
        db.delete_column('core_tabgadgetsr', 'rss_url')
